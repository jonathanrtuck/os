...
const JETBRAINS_MONO: &[u8] = include_bytes!("../../assets/jetbrains-mono.ttf");
const INTER: &[u8] = include_bytes!("../../assets/inter.ttf");
const SOURCE_SERIF_4: &[u8] = include_bytes!("../../assets/source-serif-4.ttf");
...
fn jetbrains_mono_angle_brackets_shape_and_rasterize() {
    let font_data = include_bytes!("../../assets/jetbrains-mono.ttf");
