...
**Session 2026-03-07:** Completed all 7 kernel spike steps. The spike's original question — is a from-scratch kernel tractable? — is answered. The kernel boots, sets up MMU with split TTBR, loads a standalone ELF binary into a per-process address space, runs it at EL0, and handles syscalls.
