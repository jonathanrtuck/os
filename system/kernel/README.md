...
~2,152 tests covering memory management, scheduling, IPC, processes, ELF loading, interrupt handling, syscalls, OOM fault injection, adversarial stress/fuzz scenarios, drawing, fonts, animation, layout, scene graph, and compositing.
