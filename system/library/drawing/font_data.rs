/// VGA 8×16 bitmap font — printable ASCII (0x20–0x7E, 95 glyphs).
///
/// Each glyph is 16 bytes: one byte per scanline row, MSB = leftmost pixel.
/// Public domain font data derived from the IBM VGA BIOS character set.
const FONT_8X16_DATA: [u8; 1520] = [
    // 0x20 ' '
