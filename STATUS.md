...
- Phase 7 (cursor blink + selection): IN PROGRESS — 7.1 cursor blink DONE (timer
  syscalls, animation evaluation, hypervisor SPI deassert fix, driver ack/clear
  reorder). 7.2 selection NOT STARTED.
