...
//!
//! Registers as "jpeg-decoder" with the name service, then enters an IPC
//! serve loop. Clients send a VMO containing JPEG file data along with the
...
extern "C" fn _start() -> ! {
    ...
    name::register(HANDLE_NS_EP, b"jpeg-decoder", svc_ep);
