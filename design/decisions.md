...
| #16 Tech Foundation    | Partial   | **Partially safe**   | Most sub-decisions settled (incl. driver model, filesystem placement). FileStore interface designed + macOS prototype validated (`prototype/filestore/`, 21 tests). Remaining: COW on-disk design. |
